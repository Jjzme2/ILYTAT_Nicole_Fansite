<template>
    <div class="space-y-1.5">
        <label v-if="label" :for="id || inputId" class="text-xs font-bold text-muted uppercase tracking-wider ml-1">
        ...
        <div class="relative group">
            ...
            <!-- Icon Right -->
            <div v-if="$slots['icon-right']" class="absolute right-3 top-1/2 -translate-y-1/2 text-muted transition-colors flex items-center">
